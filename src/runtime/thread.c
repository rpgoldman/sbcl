...
#endif
#ifdef THREAD_LISP_LINKAGE_TABLE_BASE_SLOT
    tls[THREAD_LISP_LINKAGE_TABLE_BASE_SLOT] = (lispobj)lisp_linkage_table;
    tls[THREAD_ALIEN_LINKAGE_TABLE_BASE_SLOT] = (lispobj)ALIEN_LINKAGE_TABLE_SPACE_START;
    tls[THREAD_HEAP_POINTER_MASK_SLOT] = 0xFFFFFFFFFFFF; // usable address-space size
#endif
